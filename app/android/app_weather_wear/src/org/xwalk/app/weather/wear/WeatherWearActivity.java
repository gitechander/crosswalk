...
package org.xwalk.app.weather.wear;
...
public class WeatherWearActivity extends XWalkRuntimeActivityBase {
    ...
    protected void didTryLoadRuntimeView(View runtimeView) {
        if (runtimeView != null) {
            ...
            getRuntimeView().loadAppFromUrl("app://org.xwalk.app.weather.wear/index.html");
        } else {
