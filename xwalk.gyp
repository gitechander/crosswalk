  ...
  'targets': [
    {
      ...
      'sources': [
        ...
        'runtime/browser/android/xwalk_autofill_client.cc',
        'runtime/browser/android/xwalk_autofill_client.h',
        ...
        'runtime/browser/android/xwalk_form_database_service.cc',
        'runtime/browser/android/xwalk_form_database_service.h',
